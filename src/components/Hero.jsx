...
import profilePic from "../assets/Prashikprofile.png" ;
        ...
        <div className="flex flex-wrap">
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    ...
                    initial="hidden"
                    animate="visible"
                    className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Prashik Ahire</motion.h1>
                    <motion.span
            ...
            <div className='flex justify-center'>
                ...
                transition={{duration: 1, delay:1.2}}
                 src={profilePic} alt="Prashik Ahire" />
            </div>
